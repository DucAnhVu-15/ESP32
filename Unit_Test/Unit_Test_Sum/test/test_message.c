...
// void test_message_NeedToImplement(void)
// {
//     TEST_IGNORE_MESSAGE("Need to Implement message");
// }
...
void test_Create_Frame_Message(void)
{
    ...
    uint8_t arr_frame_test[LENGTH_DEFAULT + LENGTH_MASTER_SET_PORT] = {0x55, 0xAA, 0x01, 0x00, 0x06, 0x00, 0x02, 0x01, , 0xFB, 0x4E};
    printf("/*-------------------------------------------------------------------------------------------------------\n*/");
    ...
    // TEST_ASSERT_EQUAL_UINT8(LENGTH_DEFAULT + LENGTH_MASTER_SET_PORT, length_frame);
