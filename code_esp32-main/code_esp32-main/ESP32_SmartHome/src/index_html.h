...
<body>
  ...
  <div style="display: flex; margin-top: 100px;" class="btn_obj">
    <div
      ...
      <div class="btn_obj">
        <a href="/manual/balcony/ledon">
          <button class="button btnOn" style="margin-right: 20px;">Bật Đèn</button>
        </a>
      ...
      <div class="btn_obj" style="margin-top: 20px;">
        <a href="/manual/balcony/ledoff">
          <button class="button btnOff" style="margin-right: 20px;">Tắt Đèn</button>
        </a>
